...
import { LayoutGrid, List, Plus, Filter, Search, Car } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500">{filteredDeals.length} deals found</p>
        </div>
        <button
      ...
      <PipelineSummary deals={filteredDeals} onStageClick={(stage) => setStageFilter(stage)} />
      ...
      {filteredDeals.length === 0 && (
        <div className="text-center py-16 bg-gray-50 rounded-2xl">
          ...
          <p className="text-lg text-gray-500 font-medium">No deals found</p>
