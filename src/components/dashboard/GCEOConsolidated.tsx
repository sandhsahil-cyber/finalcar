    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 bg-[#0f172a] -m-6 p-10 min-h-screen text-slate-200">
            <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-4xl font-black tracking-tighter uppercase text-white">Group Enterprise Suite</h2>
                    </div>
                    <p className="text-sm font-medium text-slate-400 flex items-center gap-2">
                         <Globe size={16} className="text-emerald-500" /> Consolidated Portfolio Performance & Capital Management
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {[
                    { label: 'Group Gross Revenue', value: '₹195.4 Cr', change: '+18.2%', icon: <DollarSign />, color: 'text-emerald-400' },
                    { label: 'Total Net PPU', value: '₹1.05L', change: '+4.5%', icon: <TrendingUp />, color: 'text-blue-400' },
                    { label: 'Consolidated Inventory', value: '₹842 Cr', change: '-2.1%', icon: <Box />, color: 'text-purple-400' },
                    { label: 'Active Headcount', value: '1,242', change: '+14 New', icon: <UserCheck />, color: 'text-amber-400' },
                ].map((stat, i) => (
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                <div className="xl:col-span-2 bg-slate-900 border border-slate-800 rounded-[40px] shadow-sm overflow-hidden flex flex-col">
                    <div className="p-8 border-b border-slate-800 bg-slate-800/20 flex justify-between items-center">
                        <div>
                            <h3 className="font-black text-xl tracking-tight uppercase text-white">Multi-Brand Performance Matrix</h3>
                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mt-1">Inter-Dealership Efficiency & Stock Turn</p>
                        </div>
                    ...
                    <div className="overflow-x-auto h-full">
                        <table className="w-full text-left">
                            <thead className="bg-slate-800/30 text-[10px] uppercase font-black text-slate-500 tracking-[0.2em]">
                                <tr>
                                    <th className="px-8 py-6">Brand Entity</th>
                                    <th className="px-8 py-6">MTD Revenue Index</th>
                                    <th className="px-8 py-6 text-center">Avg PPU</th>
                                    <th className="px-8 py-6 text-center">Stock Turn</th>
                ...
                <div className="space-y-8">
                    <div className="bg-[#1e293b] rounded-[40px] p-10 border border-slate-700 shadow-2xl relative overflow-hidden group">
                        ...
                        <h4 className="text-xl font-black text-white uppercase tracking-tight mb-8 relative z-10">Brand Contribution</h4>
                    ...
                    <div className="bg-slate-900 border border-slate-800 p-10 rounded-[40px] shadow-sm relative overflow-hidden">
                        ...
                        <div className="space-y-4">
                            {[
                                { title: 'Efficiency Warning', msg: 'Tesla (City A) avg delivery TAT exceeded group avg by 4.2 days.', color: 'rose' },
                                { title: 'Compliance Audit Due', msg: 'BMW Dealership is due for Q3 financial integrity audit.', color: 'amber' },
                            ].map((alert, i) => (
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-[40px] p-10 shadow-sm relative group overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="flex justify-between items-center mb-10">
                             <h4 className="text-xl font-black text-white uppercase tracking-tight">Consolidated Inventory Distribution</h4>
                    ...
                    <div className="relative z-10 h-full flex flex-col justify-between">
                        <div>
                            ...
                            <p className="text-sm font-medium opacity-70 leading-relaxed mb-10 max-w-md">
                                You have **3 group-level approval requests** pending for capital acquisition and marketing expansion.
                            </p>
                        </div>
                        <div className="space-y-4">
                            {[
