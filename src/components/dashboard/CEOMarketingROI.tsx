    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500 bg-[#020617] -m-6 p-10 min-h-screen text-slate-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {[
                    { label: 'Cost per Customer', value: '₹1,440', sub: '-₹210 vs LY', icon: <DollarSign />, color: 'text-emerald-500' },
                    { label: 'Total Ad Bill', value: '₹2.84L', sub: '92% of budget', icon: <Activity />, color: 'text-blue-500' },
                    { label: 'Walking Conversation', value: '8.4%', sub: '+1.2% this week', icon: <Target />, color: 'text-amber-500' },
